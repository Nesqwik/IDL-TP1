...
public class Environment {
    ...
    /**
     * liste des agents � ajouter
     */
    protected List<Agent> agentsToAdd = new LinkedList<>();
    /**
     * liste des agents � retirer
     */
    ...
    /**
     * actualise la liste des agents supprim�s
     */
    ...
    /**
     * R�cup�re un agent dans la grille
     * 
    ...
    /**
     * R�cup�re la liste de tous les agents
     * 
    ...
    /**
     * R�cup�re tous les voisins de Moore
     * 
    ...
    /**
     * r�cup�re les voisins de moore sans la toricit�
     * 
     * @param agent l'agent cible
    ...
    /**
     * R�cup�re la liste des voisins de moore dans un environement torique
     * 
     * @param agent l'agent cible
     * @return les voisins
     */
